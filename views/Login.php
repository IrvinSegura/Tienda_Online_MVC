...
<body>
  ...
  require("../models/Slider.php");
     ...
     <br>
     <br>
     <h2> <p class="text-info" >Iniciar Sesión </p> </h2>
                <input  class="form-control input-lg"  type="text"  placeholder="&#128102; Usuario" name="usuario" required
                       ><br>
     <br>
     ...
     <br>
      ...
      <button type="submit" class="btn btn-primary active">Iniciar Sesion</button>
