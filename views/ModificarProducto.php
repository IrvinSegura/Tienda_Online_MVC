...
if(!empty($_POST['modificar'])){
 $cve_producto =$_POST["modificar"];
        $objProductos= new Productos();
        $rowProductos=$objProductos-> get_productosCveProducto($cve_producto) ;


     
    
    	if(!empty($_POST['producto'])&&!empty($_POST['precioCompra'])&&!empty($_POST['precioVenta'])&&!empty($_POST['Descripcion'])&&!empty($_POST['proveedor'])&&!empty($_POST['catalogo'])){
...
{    echo 'El archivo se subio con exito';
 ...
 $updateproductos=$objProducto->update_productoConImagen($proveedor,$catalogo,$producto,$precioCompra,$precioVenta,$descripcion,$cve_producto,$foto);
    ...
    $objadmin=new Usuarios();
        $rowUsuario=$objadmin->get_usuarioTipo($_SESSION["usuario"]);
...
{//echo 'Error al subir ';}
 ...
 $updateproductos=$objProducto->update_productoSinImagen($proveedor,$catalogo,$producto,$precioCompra,$precioVenta,$descripcion,$cve_producto);
             // header('Location: productos.php');
    //require("../../libs/AccesoDatos.php"); 
        ...
        <div class="clearfix"></div>
           ...
           <div class="row">
             ...
             <div class="col-md-12 well" >
              ...
              <center>
                   <h2> <p class="text-info" > Modificar Producto <img src="../img/modificar.png" width="50px" height="50px"></p></h2>
            ...
            <br>
               <div class="col-md-12">
                               ...
                               <form enctype="multipart/form-data"  action="ModificarProducto.php" method="post">
                   ...
                   <div class="col-md-3">
                           ...
                           <?php            for ($i=0; $i<count($rowProductos); $i++){?>
         ...
         <input type="file" name="imagen" accept="image/jpeg, image/png ,image/jpg image/gif" type="file" name="imagen"  value="default.png"/>
                   ...
                   <img src=" <?php echo  $rowProductos[$i]["imagen"];?>" width="250px"  height="250px">
                   <?php break;}?>
                   </div>
                  <br>
                   ...
                   <h6> <p class="text-info" >Datos  del producto</p> </h6>
                      ...
                      <label>Proveedor</label>
                        <select  name="proveedor" class="form-control" required>
                             <?php            for ($i=0; $i<count($rowProductos); $i++){?>
                        <option  value="<?php  echo   $rowProductos[$i]["cve_provedor"]; ?>"><?php  echo   $rowProductos[$i]["proveedor"]; ?></option>   <?php }?>
...
<option  value="<?php  echo $rowProductos[$i]["cve_catalogo"]; ?>"><?php  echo   $rowProductos[$i]["nombre_catalogo"]; ?></option> 
                  ...
                  <?php }?>
                          ...
                          <br>
                              <?php            for ($i=0; $i<count($rowProductos); $i++){?>
                            <label>Producto</label><input  class="form-control input-lg"  type="text"  placeholder="Nombre del Producto" name="producto" value="<?php  echo   $rowProductos[$i]["producto"];?>" required>
                                
                      
                        
                        <label>Precio compra</label><input  class="form-control input-lg"  type="text"   name="precioCompra"value="<?php  echo  $rowProductos[$i]["pre_compra"];?>"  required>
                    
                        <label>Precio venta</label><input  class="form-control input-lg"  type="text" name="precioVenta" value="<?php  echo  $rowProductos[$i]["pre_venta"];?>" required>
           ...
           <label>Descripcion</label> <div class="col-md-6">
                                 <textarea  class="form-control input-lg"  type="text"  name="Descripcion"   rows="10" cols="50" required><?php  echo  $rowProductos[$i]["descripcion"];?></textarea>
                        <br><br>
                                   </div>
                         ...
                         <center>     <button type="submit" class="btn btn" ><img src="../img/modificar.png" width="50px" height="50px">Modificar Producto</button></center>
