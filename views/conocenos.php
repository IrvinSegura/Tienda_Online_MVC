        ...
        <div class="container" >
           <div class="row">
             ...
             <div class="col-md-2"  >
                 ...
                 <div class="col-md-3"  >
                     <center>
                     <img src="../img/somos/vision.jpg" width="150px" height="150px">
                     </center>
                         </div>
                    
                      <div class="col-md-7"  >
               
                     <h3> <p class="text-info" >Misi&oacute;n</p> </h3>     
                     
1.-Líder Global en Belleza<br>
2.-La elección de las mujeres para comprar<br>
3.-El Vendedor Directo Premier<br>
4.-El mejor lugar para trabajar<br>
5.-La Fundación más grande para la mujer<br>
6.-La Compañía más admirada<br>
                ...
                <center>
                    <br>
                    <br>
                     <h3> <p class="text-info" >Visi&oacute;n</p> </h3>     
...
Ser la Compañía que mejor entienda y satisfaga las necesidades de productos, servicio y autoestima de la mujer en todo el mundo.
                 ...
                 <div class="col-md-3"  >
                     <center>
                     <img src="../img/somos/mision.jpg" width="150px" height="150px">
                     </center>
                         </div>
                </div>
               <br>
