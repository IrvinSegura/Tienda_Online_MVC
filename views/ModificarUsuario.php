...
if(isset($_POST["tipousuario"]) &&isset($_POST["usuario"])&&isset($_POST["password"])) {
  $cve_usu=$_POST["modificarUsu"];
    ...
    $objUsuarios= new Usuarios();
    $rowUpdtaUsuario=$objUsuarios->update_usuario($usuario,$password,$tipoUsuario,$cve_usu);
           ...
           <div class="row">
             ...
             <div class="col-md-4" ></div>
              ...
              <center>
                   ...
                   <h2> <p class="text-info" >Modificar Usuario</p> </h2>
        <form action="ModificarUsuario.php" method="post">
         <?php   
            if(isset($_POST["modificar"])){
   $cve_usu=$_POST["modificar"];
            
               $objUsuarios2= new Usuarios();
 $rowUsuarioModificar=$objUsuarios2-> get_usuarioCve($cve_usu);
            
            ?>
            
            <input type="hidden" name="modificarUsu" value="<?php  echo $cve_usu?>">
             <?php 


                  for ($i=0; $i<count($rowUsuarioModificar); $i++){
       ...
       <select class="form-control" name="tipousuario" >
        ...
        <option value="<?php echo  $rowUsuarioModificar[$i]["tipo_usuario"]; ?>"><?php echo  $rowUsuarioModificar[$i]["tipo_usuario"]; ?></option>
        ...
        <option value="Secretaria">Secretaria</option>
            ...
            <br>
        <input  class="form-control input-lg"  type="text" value="<?php echo $rowUsuarioModificar[$i]["nombre_usuario"]; ?>" name="usuario" required><br>
        <br>
        <input  class="form-control input-lg" type="text" value="<?php echo  $rowUsuarioModificar[$i]["password"]; ?>" name="password" required>
        <br>
        <br>
     
      <button type="submit" class="btn btn" ><img src="../img/modificar.png" width="50px" height="50px">   Modificar Usuario</button>
    </center>
