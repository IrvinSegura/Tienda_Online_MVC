...
<body>
  ...
  <thead ><br><br>
     ...
     <right><a href="AgregarProductoVendedor.php"> <h5><img src="../img/agregar.png" width="50px" height="50px" >Agregar nuevo</h5></a></right><br>
    <tr>
      <th scope="col">#</th>
    ...
    <tr>
      ...
      <td><?php  echo   $rowProductos[$i]["nombre_catalogo"];?></td>
        ...
        <td> <img src="<?php  echo  $rowProductos[$i]["imagen"];?>"width='100px' height='100px'></td> 
          ...
          <td>
             <form action="EliminarProductoVendedor.php" method="post">
             <button type="submit" class="btn btn-danger">
                <img src="../img/eliminar.png" width="25px" height="25px">Eliminar</button>
                <input type="hidden" name="eliminar" value="<?php  echo  $rowProductos[$i]["cve_producto"]; ?>">
