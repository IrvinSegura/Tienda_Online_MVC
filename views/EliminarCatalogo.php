...
require("../libs/AccesoDatos.php"); 
  require("../models/Catalogos.php"); 
	...
	if(!empty($_POST["cveEliminar"])){
     $cve_catalogo =$_POST["cveEliminar"];
        
     $rowdeletcatalogo=$objcatalogo-> delete_catalogo($cve_catalogo);
...
<body>
    ...
    ?>
     <center>
                   <h2> <p class="text-info" >Esta seguro de eliminar  el catalogo</p> </h2>
           
    <form method="post" action="EliminarCatalogo.php" >
