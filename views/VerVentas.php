 ...
 require("../libs/AccesoDatos.php"); 
  require("../models/venta.php"); 
   require("../models/Catalogos.php");
        $objVentas= new Venta();
        $rowVentas=$objVentas->get_ventas() ;
...
<body>
        ...
        <div class="container" >
           <div class="row">
             ...
             <div class="col-md-12 well" >
              ...
              <center>
                   <h2> <p class="text-info" >LISTA DE VENTAS REALIZADAS<img src="../img/admin.png" width="70px" height="70px"></p> </h2>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php  echo  $rowVentas[$i]["producto"]; ?></td>
      <td><?php  echo  $rowVentas[$i]["cantidad"];?></td>
        <td><?php  echo  $rowVentas[$i]["Total"];?></td> 
             <td><?php  echo  $rowVentas[$i]["fecha"];?></td>
         <td><?php  echo  $rowVentas[$i]["id_usuario"];?></td> 
