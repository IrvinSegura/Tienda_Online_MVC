<?php 
    ...
    require("models/pedidos.php"); 
        ...
        $rowProductos=$objProductos->  get_productosrand();
?>
  ...
  require("models/Slider.php");
	   ...
	   <nav class="navbar navbar-default bootsnav"  style="background-color: #FF69B4;">
            <div class="top-search">
                ...
                <input type="text" class="form-control" placeholder="Search" id="search" onkeyup="buscadorProductos();">
            ...
            <div class="container">            
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                     ...
                     <li><a href="views/conocenos.php"> Conócenos</a></li>
                         &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  &nbsp;
                        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  &nbsp;
                        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  &nbsp;
                        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  &nbsp;
      ...
      <div class="barraCarrito">
          ...
          <form action="views/verCarrito.php" >
        <table>
           ...
           <div class="row">
             ...
             <div class="col-md-3"  >
                 ...
                 <table class="table well">
                    ...
                    <tr>
                    <th><h4> <p class="text-info" >Categorías</p> </h4></th>
                    </tr>
                    </thead>
                ...
                <tbody>
                    ...
                    <center>
                        <form method="post" action="categoria.php">
                            <input type="hidden" name="categoria" value="<?php  echo $rowCatalogo[$i]["cve_catalogo"]; ?>">
...
-->          <div class="col-md-4 "  >
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                <img src="views/<?php  echo  $rowProductos[$i]["imagen"];?>"width='200px' height='180px'  onclick="detalleproducto('<?php  echo  $rowProductos[$i]["cve_producto"];?>');">     
